...
#usage: python ndd_by_nodes_sorting_just_2_Marozzi_Cliffs_average_FIG.py MaxAbs 30 MaxAbs_ndds_ln.txt ChList.txt MaxAbs_ndds_ln_sorting_index_ftol.txt MaxAbs_Cliffs_average_ndds_Control_EtOH.txt MaxAbs_ndds_Marozzi_EtOH_Control.txt
